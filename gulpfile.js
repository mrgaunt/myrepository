...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
		...
		//'app/libs/enllax/dist/jquery.enllax.min.js',				
		//'app/libs/jquery.inputmask/dist/min/inputmask/inputmask.min.js',
		//'app/libs/jquery.inputmask/dist/min/jquery.inputmask.bundle.min',
		//'app/libs/jquery.tabs/jquery.ajaxTabs.js',		
		//'app/libs/jquery.easytabs/jquery.easytabs.js'
		])
